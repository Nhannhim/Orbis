...
def create_app(
    ...
    *,
    ...
    def orchestration_scenarios() -> Dict[str, Any]:
        return {"scenarios": intelligence.scenarios()}

    @app.post("/api/plans", status_code=201)
    def create_orchestration_plan(body: PlanCreateRequest) -> Dict[str, Any]:
        plan = intelligence.analyze(
